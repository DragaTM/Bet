...
$(document).ready(function(){
	...
	$('.solution').toggle(function() {
        $(this).find('.solution__body').slideDown();
		$(this).find('i').css("background-position", "-5px -5px");
  }, function() {
	    $(this).find('.solution__body').slideUp();
		$(this).find('i').css("background-position", "-5px -22px");
  });	
});

$(document).ready(function(){
 	$('.setting-menu__country a').toggle(function(event){
		event.preventDefault();
 	$(".country__field").slideDown('fast');
	}, function(event) {
		event.preventDefault();
 	$(".country__field").slideUp('fast');
	});
});

$(document).ready(function(){
 	$('.change-password').toggle(function(event){
		event.preventDefault();
 	$(".setting-menu__password-field").slideDown('fast');
	}, function(event) {
		event.preventDefault();
 	$(".setting-menu__password-field").slideUp('fast');
	});
});
...
$(document).ready(function () {
	...
	var closeRegPopup	= document.querySelector(".popup-reg__close");
	var closeLoginPopup	= document.querySelector(".popup-login__close");
	...
	for (var i = 0; i < btnLoginPopup.length; i++) {
       	btnLoginPopup[i].addEventListener('click', function(event) {
			event.preventDefault();
